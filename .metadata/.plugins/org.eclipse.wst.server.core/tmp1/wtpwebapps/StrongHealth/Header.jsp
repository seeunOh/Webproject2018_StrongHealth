...
<li>&nbsp</li>
 ...
 <li class="topmenu"><a class="menuLink" href="Container.jsp?selected_page=healthcare_food">헬스케어</a>
   <ul class="submenu">
     <li class="submenuLink"><a href="Container.jsp?selected_page=healthcare_food">추천 건강푸드</a></li>
     <li class="submenuLink"><a href="Container.jsp?selected_page=healthcare_stretching">스트레칭</a></li>
     <li class="submenuLink"><a href="Container.jsp?selected_page=music">추천음악</a></li>
   </ul>
</li>
 <li class="topmenu"><a class="menuLink" href="Container.jsp?selected_page=healthcare_news">자료실</a>
 	<ul class="submenu">
     <li class="submenuLink"><a href="Container.jsp?selected_page=healthcare_news">건강신문</a></li>
   </ul>
 </li>
